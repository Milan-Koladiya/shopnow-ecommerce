...
$query="select * from categoryinformation3 where category='Men,Women Fashion' limit $page1,5";
	...
	<ul>
	 ...
	 <?php } ?>
		...
		?>
			...
			<div>
			<?php
				$query="select * from categoryinformation3 where category='Men,Women Fashion'";
				$query_run=mysqli_query($con,$query);
			...
			{
			?>
				<a href="menfashion.php?page=<?php echo $page-1?>"><button style="background-color:red; font-size:15px; width:100px" class="delete_btn"><b>
				Privious</b></button></a>
			<?php
			}
			?>
			<?php
				...
				{
			?>
				<a href="menfashion.php?page=<?php echo $b?>"><button style="background-color:#4CAF50; font-size:15px; width:5px;" class="delete_btn">
			...
			{
			?>
				<a href="menfashion.php?page=<?php echo $page+1?>"><button style="background-color:red; font-size:15px; width:70px" class="delete_btn"><b>
				Next</b></button></a>
			<?php
			}
			?>
