<?php
			...
			require 'dbconfi/confi.php';
				...
				$query="SELECT * FROM commentlike WHERE username='$username' AND commentname='$commentname' AND pid='$id' AND action='Like'";
				...
				{
					$query="SELECT * FROM commentlike WHERE username='$username' AND pid='$id' ANd commentname='$commentname' AND action='DisLike'";
					$query_run=mysqli_query($con,$query);
					if(mysqli_num_rows($query_run)>0)
					{
